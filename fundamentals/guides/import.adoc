...
:movies-actors-url: http://data.neo4j.com/intro/movies/movies_actors.csv
...
[options=headers]
,===
include::{movies-actors-url}[lines=1..3]
,===
...
----
LOAD CSV WITH HEADERS FROM  
     '{csv-url}depts-member.csv' AS row
FIELDTERMINATOR ';'
