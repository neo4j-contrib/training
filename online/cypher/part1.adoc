...
link:/graphacademy/online-training/getting-started-graph-databases-neo4j-part-2/[Continue to Part 2: Creating and Querying,role="next-section medium button"]
